...
export default function LForm99() {
  ...
  return (
    <div>
        ...
        <TextField  label="Name" variant="outlined" className='coll-11' name="Name" onChange={mychenj}/><br/><br/>
       

        <TextField select name="Egucation" className='coll-11'  label="Egucation" onChange={mychenj} SelectProps={{native: true,}}>
        <option>Egucation</option><option>10 Pass</option> <option>12 pass</option><option>greguaet</option><option>No</option>
        </TextField><br/><br/>


        <TextField select name="colifecation" className='coll-11'  label="colifecation" onChange={mychenj} SelectProps={{native: true,}}>
